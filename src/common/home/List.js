                    ...
                    this.props.listtype.map((v,i)=>{
                         return <div id={"list_wrap"} key={i}>
                             ...
                             {v.list?v.list.slice(0,1).map((v, i) => {
                                return <div className={"list-top"} style={{background:"#3f3c40"}} key={i}>
                                     <div className={"pic"}>
                                         <img src={v.pic} alt=""/>
                                     </div>
                                     <div className={"xinxi"}>
                                 ...
                                 <div className={"swiper-wrapper buttom-list"}>
                                     {
                                         v.list?v.list.slice(1).map((v,i)=>{
                                             return  <div className={"swiper-slide liebiao"} key={i}>
                                                 <img src={v.pic} alt=""/>
...
export default connect((state)=>({listtype:state.home.listtype}),(dispatch)=>bindActionCreators(getList,dispatch))(List)